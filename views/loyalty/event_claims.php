...
<div class="row mb-3">
    <div class="col-md-6">
        <form id="claim-form" action="<?= url('/loyalty/processEventClaim') ?>" method="POST" class="d-flex gap-2 align-items-center">
            <?= csrf_field() ?>
            ...
            <input type="text" id="qr_code_input" name="qr_code" class="form-control rounded-pill" placeholder="Cari / Masukkan Kode Klaim..." value="<?= htmlspecialchars($_GET['code'] ?? '') ?>" required autofocus>
            <button type="submit" class="btn btn-success rounded-pill px-4" style="flex-shrink:0;">Tandai Selesai</button>
        </form>
