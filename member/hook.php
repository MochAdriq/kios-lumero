...
<div class="wrapper">
    ...
    <div class="claim-banner">
        ...
        <a href="index.php?login=1&claim=<?= urlencode($claimCode) ?>" class="btn-stripe btn-primary" style="padding: 10px 20px; font-size: 13px;">Klaim &rarr;</a>
    </div>
    <?php endif; ?>
    ...
    <header class="hero-section">
        <div class="hero-content">
            ...
            <div class="cta-stack">
                <a href="index.php?login=1<?= $claimCode !== '' ? '&claim=' . urlencode($claimCode) : '' ?>" class="btn-stripe btn-primary">
                    Mulai Gabung Sekarang &rarr;
                </a>
                <a href="index.php?login=1" class="btn-stripe btn-secondary">
                    Masuk ke Akun
                </a>
            </div>
        </div>
    ...
    <section>
        ...
        <div class="reward-showcase">
            ...
            <div class="reward-item" onclick="window.location.href='index.php?login=1'" style="cursor:pointer;">
        ...
        <div style="text-align: center; margin-top: 40px;">
            <a href="index.php?login=1" class="btn-stripe btn-primary">Login / Daftar untuk Klaim</a>
        </div>
    </section>
