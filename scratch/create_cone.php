...
if (!$stmt->fetch()) {
    ...
    $ins = $pdo->prepare("INSERT INTO raw_materials (outlet_id, category_id, sku, name, unit_id, average_cost, is_active) VALUES (?, ?, ?, ?, ?, 0, 1)");
    $ins->execute([$outlet_id, $category_id, $sku, $name, $unit_id]);
