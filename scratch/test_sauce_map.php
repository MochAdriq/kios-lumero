<?php
$rawVars = file_get_contents('scratch/query_ayam_vars.php');
// The output of query_ayam_vars.php was saved, let's just use the known list:
$vars = [
...
$sauceDefs = [
    ...
    ['key'=>'sadis', 'match'=>['sadis', 'geprek', 'pedas', 'spicy', 'smashed chili']],
    ['key'=>'bbq', 'match'=>['bbq', 'barbeque']],
