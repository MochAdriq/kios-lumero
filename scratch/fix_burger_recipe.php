...
$items = [
    'DC-MNU-19-PSKL-VAR' => [
        'name' => 'Cheese Burger',
        'ingredients' => ['Roti Burger (Bun)', 'Daging Patty Sapi', 'Daun Selada', 'Mayonnaise', 'Saus Tomat/Sambal', 'Kotak Burger'],
        'selling_price' => 15000 // default or leave empty
    ]
];
...
try {
    ...
    $pdo->commit();
    echo "\nSelesai! Resep untuk Cheese Burger (-VAR) berhasil di-update/inject ke Database PROD Outlet $outletId.\n";
