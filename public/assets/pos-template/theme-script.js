...
const simTemplateIconBase = new URL('../tabler-sprite.svg', document.currentScript?.src || window.location.href).href;
function simTemplateIcon(name, className = '') {
    let iconName = String(name || '').replace(/^ti ti-/, '').replace(/^ti-/, '');
    if (iconName.endsWith('-filled')) {
        iconName = `filled-${iconName.slice(0, -7)}`;
    }
    if (iconName === 'cash-register') {
        iconName = 'cash-banknote';
    }
    const classes = ['sim-icon', className].filter(Boolean).join(' ');
    return `<svg class="${classes}" width="1.25em" height="1.25em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" style="display:inline-block;vertical-align:-0.125em;flex:0 0 auto"><use href="${simTemplateIconBase}#tabler-${iconName}"></use></svg>`;
}

let themesettings = `
<div class="sidebar-contact ">
    <div class="toggle-theme"  data-bs-toggle="offcanvas" data-bs-target="#theme-setting">${simTemplateIcon('ti-settings', 'fa-spin')}</div>
    </div>
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between bg-dark">
        ...
        <a href="#" class="custom-btn-close d-flex align-items-center justify-content-center text-white"  data-bs-dismiss="offcanvas">${simTemplateIcon('ti-x')}</a>
    </div>
    <div class="themecard-body offcanvas-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="theme-width m-1 me-2">
                                ...
                                <label for="fluidWidth" class="d-block rounded fs-12">
                                    ${simTemplateIcon('ti-layout-list', 'me-1')}
                                    Fluid Layout
                                </label>
                            </div>
                            <div class="theme-width m-1">
                                ...
                                <label for="boxWidth" class="d-block rounded fs-12">
                                 ${simTemplateIcon('ti-layout-distribute-horizontal', 'me-1')}
                                    Boxed Layout
                                </label>
                            </div>
                        </div>  
                       ...
                       <div class="d-flex align-items-center">
                            <div class="theme-mode flex-fill text-center w-100 me-3">
                                ...
                                <label for="lightTheme" class="rounded fw-medium w-100">                            
                                    <span class="d-inline-flex rounded me-2">${simTemplateIcon('ti-sun-filled')}</span>Light
                                </label>
                            </div>
                            <div class="theme-mode flex-fill text-center w-100 me-3">
                                <input type="radio" name="theme" id="darkTheme" value="dark" >
                                <label for="darkTheme" class="rounded fw-medium w-100">                         
                                    <span class="d-inline-flex rounded me-2">${simTemplateIcon('ti-moon-filled')}</span>Dark
                                </label>
                            </div>
                            <div class="theme-mode flex-fill w-100 text-center">
                                ...
                                <label for="systemTheme" class="rounded fw-medium w-100">                         
                                    <span class="d-inline-flex rounded me-2">${simTemplateIcon('ti-device-laptop')}</span>System 
                                </label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="p-3 pt-0">
            <div class="row gx-3">
                <div class="col-6">
                    <a href="#" id="resetbutton" class="btn btn-light close-theme w-100">${simTemplateIcon('ti-restore', 'me-1')}Reset</a>
                </div>
                <div class="col-6">
                    <a href="#" class="btn btn-primary w-100" data-bs-dismiss="offcanvas">${simTemplateIcon('ti-shopping-cart-plus', 'me-1')}Buy Product</a>
                </div>
            </div>
        </div>    
    </div>
