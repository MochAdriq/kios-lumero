...
$(document).ready(function(){
	...
	if ($('.notes-slider').length > 0) {
		$('.notes-slider').owlCarousel({
			...
			nav: true,
			smartSpeed: 2000,
			navText: [simTemplateIcon('ti-chevron-left'), simTemplateIcon('ti-chevron-right')],
			responsive: {
				0: {
					items: 1
				},
	...
	if($('.datatable').length > 0) {
		$('.datatable').DataTable({
			...
			"language": {
				...
				paginate: {
					next: ` ${simTemplateIcon('ti-chevron-right')}`,
					previous: `${simTemplateIcon('ti-chevron-left')} `
				},
			 },
  ...
  //Increment Decrement Numberes
	...
	$(".add-extra").on('click', function () {
		...
		var servicecontent = '<div class="row">' +
			...
			'<a href="#" class="btn btn-danger-outline trash">' + simTemplateIcon('ti-trash') + '</a>' +
			'</div>' +
			'</div>' +
			'</div>';
...
$(document).ready(function(){
	...
	if ($('.channels-slider').length > 0) {
		$('.channels-slider').owlCarousel({
			...
			navText: [
				simTemplateIcon('ti-arrow-narrow-left'),
				simTemplateIcon('ti-arrow-narrow-right')
			],
			responsive: {
				0: {
					items: 3
		...
		'<div class="row align-items-center g-2">'+
			...
			'<div class="col-lg-2">'+
				'<div class="d-flex align-items-center gap-2">'+
					...
					'<a href="#" class="trash-icon">' + simTemplateIcon('ti-trash') + '</a>'+
				'</div>'
			'</div>'+
		'</div>'+
	'</div>';
